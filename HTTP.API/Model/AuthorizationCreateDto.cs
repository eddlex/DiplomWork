...
namespace Camunda.Http.Api.Model
{
    ...
    public partial class AuthorizationCreateDto : IEquatable<AuthorizationCreateDto>, IValidatableObject
    {
        ...
        public AuthorizationCreateDto(string clientId = default(string), string password = default(string))
        {
        ...
        [DataMember(Name = "passwword", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UserId: ").Append(ClientId).Append("\n");
